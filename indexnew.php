							...
							<div class="home__feed-content">
								<div class="home__feed-news">
									<div class="title-block">
										<h2 class="title-two"><a href="#">Новости</a></h2>
												...
												<div class="swiper-slide">
													<a href="#">
														...
														<div class="home__feed-news-slider-info">
															...
															<h4 class="title-four">
																В Университете МЧС прошло персональное распределение
																выпускников
															</h4>
															<p class="text-caption">
																В Университете гражданской защиты состоялось
																персональное распределение выпускников. Мероприятие
																определило места дальнейшей службы молодых офицеров.
																В работе Государственной комиссии принял участие
												...
												<li class="home__feed-news-item">
													<a href="#">
														...
														<div class="home__feed-news-info">
															...
															<p>
																«А теперь, внимание, вопрос? Кто лучшие знатоки
																Беларуси в области безопасности
															</p>
														</div>
													</a>
												</li>
												<li class="home__feed-news-item">
													<a href="#">
														...
														<div class="home__feed-news-info">
															...
															<p>
																В Азербайджане проходят Международные соревнования
																юных спасателей
															</p>
														</div>
													</a>
								...
								<div class="home__feed-event">
									...
									<ul class="home__feed-event-list">
										<li class="home__feed-event-item">
											<a href="#">
												<div class="home__feed-event-date">
													<p><strong>27</strong> МАР</p>
												</div>
												<div class="home__feed-event-info">
													<h4>
														Подведение итогов Республиканского конкурса «Школа
														безопасности»
													</h4>
													<p>Образовательный центр безопасности</p>
												</div>
											</a>
										</li>
										<li class="home__feed-event-item">
										...
										<li class="home__feed-event-item">
											<a href="#">
												...
												<div class="home__feed-event-info">
													<h4>
														XII Международная заочная научно-практическая конференция
														«Гражданская защита: с охранение жизни, материальных
										...
										<div class="universities__slider-content">
											...
											<ul class="universities__slider-list">
												<li class="universities__slider-list-item">
													<a href="#">
														<div class="icon">
															<iconify-icon icon="iconamoon:check-bold" width="100%" height="100%" noobserver></iconify-icon>
														</div>
														<p>Факультет предупреждения и ликвидации ЧС</p>
													</a>
												</li>
