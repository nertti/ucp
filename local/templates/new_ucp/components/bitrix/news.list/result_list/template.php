...
<a href="#" data-total="<?=$arResult["NAV_RESULT"]->NavRecordCount?>" data-id="<?=$arResult["ID"]?>" data-tpl="<?=$arResult["CODE"]?>" data-section="<?=intval($arResult["ITEMS"][0]["IBLOCK_SECTION_ID"])?>" data-num="<?=$arParams["NEWS_COUNT"]?>" class="view-more">Загрузить еще</a>
<?endif;?>