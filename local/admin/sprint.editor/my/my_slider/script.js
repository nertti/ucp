sprint_editor.registerBlock('my_slider', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'complex_left_image_slide', title: 'слайд картинка слева'},
        {id: 'complex_right_image_slide', title: 'слайд картинка справа'},
    ];
