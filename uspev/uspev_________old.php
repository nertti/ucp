...
echo "<div align='left' class='стиль40'> Текущая успеваймость</div>";
    ...
    //    echo '    Row number - ' , iconv('utf-8', 'cp1251',$row->getRowIndex()) , ' ';
     ...
     //   )->getValue())), ' '."</td>";
	    ...
	    echo "<td>".iconv('utf-8', 'cp1251',($objPHPExcel->getActiveSheet()->getCell(
		 ...
		 echo "<td><div align='center'>".iconv('utf-8', 'cp1251',($objPHPExcel->getActiveSheet()->getCell(
            'D'.$row->getRowIndex()
...
//echo $name.' ';
//echo "<div align='center' class='стиль32'>".$name.' '."</div>";
echo "<br><br><div align='left' class='стиль40'> 1-й семестр</div>";
//$inputName = iconv('cp1251', 'utf-8',$name);
...
echo '</table>';
 ...
 echo "<div align='left' class='стиль40'> 4-й семестр</div>";
$autoFilter->getColumn('C')
    ->setFilterType(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER)
    ->createRule()
		->setRule(
...
echo '</table>';
 ...
 echo "<div align='left' class='стиль40'> 5-й семестр</div>";
$autoFilter->getColumn('C')
    ->setFilterType(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER)
    ->createRule()
		->setRule(
...
echo '</table>';
 ...
 echo "<div align='left' class='стиль40'> 6-й семестр</div>";
$autoFilter->getColumn('C')
    ->setFilterType(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER)
    ->createRule()
		->setRule(
...
echo '</table>';
 ...
 echo "<div align='left' class='стиль40'> 7-й семестр</div>";
$autoFilter->getColumn('C')
    ->setFilterType(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER)
    ->createRule()
		->setRule(
