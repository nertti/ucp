...
$APPLICATION->SetTitle("Испытания специальной защитной одежды пожарного общего назначения, подшлемника и белья термостойкого для пожарных");
...
<tr>
 ...
 <a target="_blank" href="https://ucp.by/upload/NIIPB/Doc/14567Zayavka.docx">Файл</a>
		...
		<tr>
			...
			<td colspan="1">
				 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<a href="mailto:likv.niipb@ucp.by">likv.niipb@ucp.by</a>
			</td>
		</tr>
		</tbody>
		</table>
 ...
 <br>
		...
		<p>
 <u><b>ОБРАЗЦЫ (ПРОТИВОГАЗЫ) КУРЬЕРСКОЙ ДОСТАВКОЙ И ПО ПОЧТЕ НЕ ПРИНИМАЮТСЯ И НЕ ОТПРАВЛЯЮТСЯ.</b></u>
		</p>
		<p>
		</p>
		<p>
