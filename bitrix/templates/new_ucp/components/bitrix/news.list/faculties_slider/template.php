<section class="home__universities">
						<div class="home__container">
							<div class="universities__slider swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
								<div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); transition-delay: 0ms;"><div class="swiper-slide swiper-slide-active" data-swiper-slide-index="1" style="width: 1530px; margin-right: 60px;">
									...
									<div class="swiper-slide swiper-slide-next" data-swiper-slide-index="0" style="width: 1530px; margin-right: 60px;">
										<div class="universities__slider-content">
											<h2 class="title-two">Факультеты</h2>
											<ul class="universities__slider-list">
												<li class="universities__slider-list-item">
