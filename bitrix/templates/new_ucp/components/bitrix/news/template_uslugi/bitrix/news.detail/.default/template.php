        ...
        <div class="page__content">
            ...
            <div class="page__content-block">
                ...
                <div class="page__info">
                    ...
                    <?php if($arResult['PROPERTIES']['REG']['VALUE'] == "Да"):?>
                    ...
                    <?php endif; ?>
                              <?php if (!empty($arResult["PROPERTIES"]["DOC"]["VALUE"])): ?>
                    <ul class="documents">
                        <?php 
                        $docCounter = 1;
                        foreach ($arResult["PROPERTIES"]["DOC"]["VALUE"] as $fileId): 
                            $file = CFile::GetFileArray($fileId);
                            if ($file): 
                                $fileName = $file['ORIGINAL_NAME'] ?: 'Документ ' . $docCounter;
                                ...
                                } elseif ($fileExt == 'jpg' || $fileExt == 'jpeg' || $fileExt == 'png' || $fileExt == 'gif') {
                                    $iconName = 'bi:file-earmark-image-fill';
                                }
                                ?>
                                <li class="documents__item">
                                    <a href="<?php echo $file['SRC']; ?>" target="_blank" download>
                                        <div class="icon">
                                            <div class="icon-wrapper">
                                                <iconify-icon icon="<?php echo $iconName; ?>" width="100%" height="100%" noobserver></iconify-icon>
                                            </div>
                                        </div>
                                        <p><?php echo $docCounter . '. ' . htmlspecialcharsbx($fileName); ?></p>
                                        <button type="button">
                                            <iconify-icon icon="lucide:chevron-right" width="24" height="24" noobserver></iconify-icon>
                                        </button>
                                    </a>
