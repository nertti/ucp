        ...
        <div class="page__content">
            ...
            <div class="page__content-block">
                ...
                <div class="page__action">
					<a href="/new/sobytiya/" class="button-blue _prev">
                        <iconify-icon icon="lucide:chevron-left" width="24" height="24" noobserver></iconify-icon>
                        <span>Ко всем новостям</span>
                    </a>

					<a href="/new/sobytiya/?ELEMENT_ID=29082<?//php echo $arResult["NEXT_ELEMENT"]["DETAIL_PAGE_URL"]; ?>" class="button-blue _next">
